                ...
                <teiHeader>
                    <fileDesc>
                        ...
                        <sourceDesc>
                            <msDesc>
                                ...
                                <history>
                                    <origin>
                                        <p xml:lang="fr">La lettre a été écrite à <origPlace>...</origPlace> le <origDate when-iso="19..-..-..">...</origDate></p>
                                        <p xml:lang="en">The letter has been written in <origPlace>...</origPlace> on <origDate when-iso="19..-..-..">...</origDate></p>
                                    </origin>
                                    <acquisition>
                    ...
                    <profileDesc>
                        <correspDesc>
                            ...
                            <correspContext>
                                <ref type="prev" target=".xml"/>
                                <ref type="next" target=".xml"/>
                            </correspContext>
                        </correspDesc>
                        <langUsage>
                            <language ident="fr"/>
